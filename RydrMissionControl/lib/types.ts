...
export interface DriverRecord {
  ...
  phoneVerificationStepCompleted?: boolean;
  ...
  identityVerificationStepCompleted?: boolean;
  backgroundCheckStepCompleted?: boolean;
  payoutsStepCompleted?: boolean;
  driverSignupCompleted?: boolean;
  driverSignupCompletedAt?: { toDate?: () => Date } | null;
  driverOnboardingCurrentStep?: string;
  driverOnboardingCurrentStepLabel?: string;
  driverOnboardingCurrentStepIndex?: number;
  driverOnboardingTotalSteps?: number;
  driverOnboardingStatus?: "not_started" | "in_progress" | "completed";
  driverOnboardingLastSeenAt?: { toDate?: () => Date } | null;
  driverOnboardingLastSeenSource?: string;
